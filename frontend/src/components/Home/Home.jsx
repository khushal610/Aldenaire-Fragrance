...
function Home() {
  ...
  const [text] = useTypewriter({
    words:['Welcome to Aldenaire Fragrance', 'Explore Our Collection'],
    loop: {},
    typeSpeed: 60,
    deleteSpeed: 30,
  });
          ...
          <div className='min-h-screen home-container flex items-center justify-center'>
              <div className='right-part-home p-5 w-full flex flex-col items-center justify-center text-white'>
                ...
                <div className='flex gap-4 pt-10 text-black'>
                  <button className='btn1 px-5 py-2 rounded-full flex items-center gap-1' onClick={scrollToSection}><CgDetailsMore /> View More</button>
                  <NavLink to={'/shop-products'}><button className='btn1 px-5 py-2 rounded-full flex items-center gap-1'><GiShoppingBag /> Shop Now</button></NavLink>
                </div>
              </div>
          </div>
        </div>
